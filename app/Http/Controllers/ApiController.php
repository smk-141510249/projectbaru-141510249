...
class ApiController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $detail = $user::select('users.id as uid', 
                                ...
                                'jabatans.nama_j as jabatan', 
                                'jabatans.besar_uang as uangjabatan',
                                'golongans.nama_g as golongan',
                                'golongans.besar_uang as uanggolongan',
                                DB::raw('(jabatans.besar_uang + golongans.besar_uang) as gaji'))
